...
<details>
  ...
  7. Открыть фотографию для полноэкранного просмотра
  ...
  7.3. Если надпись не видно - добавить ей контрастности в редакторе изображений
  8. На сервере "Новая жизнь" добраться до указных координат
