...
<details>
  ...
  2. Находим порядковый номер буквы в алфавите
...
* Задание: Строку с числами преобразовать в знаменитую фразу Цезаря
...
<details>
  ...
  1. Преобразовать набор чисел в строку букв по порядковому номеру букв
  2. Используя шифр Цезаря расшифровать послание
